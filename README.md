...
Хорошая практика, когда в стилях любого блока ни один цвет, оступ или размер (текста) не пишется руками, используются только переменные. Это делает блок по умолчанию кастомным и готовым к дальнейшим изменениям.
